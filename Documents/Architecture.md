...
Kiyora is a privacy-preserving credential and access-verification dApp built on the Midnight Network.
...
├── Documents/
│   ├── DEMO_CHECKLIST.md
│   ├── midnight_level3_Kiyora_plan.md
│   ├── PLAN.md
│   ├── PROPOSAL.md
│   └── TRUST_MODEL.md
│
...
ZK configuration loaded
        ↓
Kiyora contract joined or deployed
        ↓
...
Kiyora supports Midnight-compatible browser wallets through the dApp Connector API.
...
During proof generation, Kiyora can represent stages such as:
...
This is the main Compact smart contract and the source of the Kiyora circuits.
...
Kiyora uses a clear separation of responsibility:
